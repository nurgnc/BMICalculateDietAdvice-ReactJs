...
function Nav() {
  return (
    <HStack spacing='24px' p={5} bg='lightseagreen' >
      <Container maxW='container.xl' display={{ lg: 'flex', md: 'flex' }} alignItems='center' justifyContent={"space-between"}>
        ...
        <Box display={{ lg: 'flex', md: 'flex' }} alignContent='center'>
          ...
          <Link to="/about"><Text mx='6' fontSize='lg' color='white' >🔎 What's the BMI?</Text></Link>
